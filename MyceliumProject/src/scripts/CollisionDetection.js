...
function collisionBranchFoodNode(branch, foodNode){
    ...
    else { // intercept found, further test the branch to see if it's within the segment
      u1 = (b - d) / c;  // these represent the unit distance of point one and two on the branch
      u2 = (b + d) / c;    
      intersectionPoint = {};   // return point
      if(u1 <= 1 && u1 >= 0){  // add point if on the branch segment
